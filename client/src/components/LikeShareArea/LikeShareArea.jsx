...
const LikeShareArea = () => {
  ...
  const handleKeyActivate = (e, handler) => {
  ...
  return (
    <div className="LikeShareArea">
      ...
      <div
        className="LikeShare"
        role="group"
        aria-label="Like and share controls"
      >
        <div
          className="like"
          role="button"
          ...
          onKeyDown={(e) => handleKeyActivate(e, handleLikeClick)}
        >
          <svg
        ...
        <div
          ...
          onKeyDown={(e) => handleKeyActivate(e, handleShareEvent)}
        >
          <svg
            ...
            width="36px"
            height="36px"
            viewBox="0 0 675.000000 675.000000"
            preserveAspectRatio="xMidYMid meet"
          >
            <g transform="translate(0.000000,675.000000) scale(0.100000,-0.100000)">
              <path
                d="M3949 5667 c-59 -50 -59 -46 -59 -525 l0 -439 -87 -17 c-49 -9 -122
...
373 10 11 13 9 53 -25z"
              />
              <path
                d="M1700 5244 c-93 -14 -159 -30 -205 -50 -147 -63 -232 -116 -323 -199
