                ...
                <div className="second-block">
                    <div className="post">
                        <div className="post-box">
                            ...
                            </div>                            <div className="post-description">
                        ...
                        <div className="requirements">
                            ...
                            <div className="requirements-list" dangerouslySetInnerHTML={{ __html: data && data.requirements }} />
                        </div>
                        ...
                        <div className="email">
                            <div className="emailpic">
                                <svg width="25" height="13" viewBox="0 0 25 13" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path d="M1.13184 1.1001L12.5003 11.9001L23.8687 1.1001" stroke="#8D91B0" strokeLinecap="round" strokeLinejoin="round" />
                                </svg>
