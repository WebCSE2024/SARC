...
router.patch("/toggle-status/:id", authenticate, requireRole(UserType.ADMIN), toggleReferralState);
router.delete("/delete/:id", authenticate, requireRole(UserType.ADMIN), deleteReferral);
