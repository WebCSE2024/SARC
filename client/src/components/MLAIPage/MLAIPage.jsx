...
export default function MLAIPage({ onBack, showBack = false }) {
	const data = publications.find((d) => d.domain === "AI/ML");
	const [view, setView] = useState("publications"); // publications | professors | seminars
	...
	return (
		<section className="mlai">
				...
				<div className="mlai__content container">
					<h1 className="mlai__title">AI / ML</h1>
					...
					{view === "professors" && (
						<div className="container mlai__list" style={{marginTop: "2rem"}}>
							<h2 className="mlai__section-title">Professors in this domain</h2>
							<div className="mlai__cards">
					...
					{view === "seminars" && (
						<div className="container mlai__list" style={{marginTop: "2rem"}}>
							<h2 className="mlai__section-title">Seminars</h2>
							<div className="mlai__cards">
