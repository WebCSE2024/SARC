...
export const addLike = asyncHandler(async (req, res) => {
  ...
  if (!newLike) throw new ApiError(500, "Error adding like");

  res
    .status(201)
    .json(new ApiResponse(201, "Like added successfully", newLike));
});
...
export const removeLike = asyncHandler(async (req, res) => {
  ...
  if (!like) throw new ApiError(500, "Error removing like");
